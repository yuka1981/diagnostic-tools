  ...
  updateVisibility() {
    ...
    if (this.hasButtonTarget) {
      ...
      if (this.visibleValue) {
        this.buttonTarget.classList.remove("bg-slate-200")
        this.buttonTarget.classList.add("bg-teal-600")
        ...
        this.buttonTarget.classList.remove("bg-teal-600")
        this.buttonTarget.classList.add("bg-slate-200")
