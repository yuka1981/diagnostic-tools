  ...
  updateUI() {
    ...
    this.cellTargets.forEach(cell => {
      ...
      if (selectedId && cellNodeId === selectedId) {
        cell.classList.add("ring-2", "ring-primary-5", "ring-offset-2", "dark:ring-offset-neutral-85")
        cell.classList.remove("hover:scale-105")
      } else {
        cell.classList.remove("ring-2", "ring-primary-5", "ring-offset-2", "dark:ring-offset-neutral-85")
